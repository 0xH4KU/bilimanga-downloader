...
def main() -> int:
    ...
    package_text = (ROOT / "src/bilimanga_dl/__init__.py").read_text(encoding="utf-8")
    ...
    if package_version != pyproject_version:
        mismatches.append(
            f"src/bilimanga_dl/__init__.py version is {package_version}, expected {pyproject_version}.",
        )
